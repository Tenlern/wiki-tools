...
<template>
    <div class="flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800 p-3">
        <div class="flex flex-col top-0 left-0 w-64 bg-white h-full border-r p-3">
            <div class="flex items-center justify-center h-14 border-b">
                <div>
                    Sidebar Navigation By iAmine
                </div>
            </div>
